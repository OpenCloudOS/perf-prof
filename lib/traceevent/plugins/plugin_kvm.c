...
#define SVM_EXIT_REASONS \
	...
	_ER(EXIT_EFER_WRITE_TRAP,	0x08f)	\
	_ER(EXIT_CR0_WRITE_TRAP,	0x090)	\
	_ER(EXIT_CR1_WRITE_TRAP,	0x091)	\
	_ER(EXIT_CR2_WRITE_TRAP,	0x092)	\
	_ER(EXIT_CR3_WRITE_TRAP,	0x093)	\
	_ER(EXIT_CR4_WRITE_TRAP,	0x094)	\
	_ER(EXIT_CR5_WRITE_TRAP,	0x095)	\
	_ER(EXIT_CR6_WRITE_TRAP,	0x096)	\
	_ER(EXIT_CR7_WRITE_TRAP,	0x097)	\
	_ER(EXIT_CR8_WRITE_TRAP,	0x098)	\
	_ER(EXIT_CR9_WRITE_TRAP,	0x099)	\
	_ER(EXIT_CR10_WRITE_TRAP,	0x09a)	\
	_ER(EXIT_CR11_WRITE_TRAP,	0x09b)	\
	_ER(EXIT_CR12_WRITE_TRAP,	0x09c)	\
	_ER(EXIT_CR13_WRITE_TRAP,	0x09d)	\
	_ER(EXIT_CR14_WRITE_TRAP,	0x09e)	\
	_ER(EXIT_CR15_WRITE_TRAP,	0x09f)	\
	_ER(EXIT_INVPCID,	0x0a2)		\
	_ER(EXIT_NPF, 		0x400)		\
	_ER(EXIT_AVIC_INCOMPLETE_IPI,		0x401)	\
	_ER(EXIT_AVIC_UNACCELERATED_ACCESS,	0x402)	\
	_ER(EXIT_VMGEXIT,       0x403)	\
	_ER(VMGEXIT_MMIO_READ,			0x80000001)	\
	_ER(VMGEXIT_MMIO_WRITE,			0x80000002)	\
	_ER(VMGEXIT_NMI_COMPLETE,		0x80000003)	\
	_ER(VMGEXIT_AP_HLT_LOOP,		0x80000004)	\
	_ER(VMGEXIT_AP_JUMP_TABLE,		0x80000005)	\
	_ER(VMGEXIT_PSC,			0x80000010)	\
	_ER(VMGEXIT_GUEST_REQUEST,		0x80000011)	\
	_ER(VMGEXIT_EXT_GUEST_REQUEST,		0x80000012)	\
	_ER(VMGEXIT_AP_CREATION,		0x80000013)	\
	_ER(VMGEXIT_HV_FEATURES,		0x8000fffd)	\
	_ER(VMGEXIT_TERM_REQUEST,		0x8000fffe)	\
	_ER(EXIT_ERR,		-1)
